...
const TeacherSidebar = ({ teacherRender, setTeacherRender }) => {
    return (
        <>
            <div className="teacher_sidebar w-[274px] h-full border-r-2 border-primary-3 border-solid p-6 flex flex-col items-center justify-start">
                <img className="w-full h-12" src="https://placehold.co/200x80" alt="" />
                ...
                <div className="flex flex-col items-center justify-center gap-6 mt-24">
                    ...
                    <button onClick={() => setTeacherRender('Databank')} className="teacher_sidebar_entry w-full flex items-center gap-2">
                        ...
                        <p className={`font-medium text-[20px] text-start select-none ${teacherRender === 'Databank' ? 'text-secondary-1' : 'text-text-1'}`}>Data Bank</p>
                    </button>
